# Git Standards and Processes

This directory contains the standards, guidelines, and processes defined for source control management and collaboration in the Rookie Data DN 2026 project.

> **Version:** 1.0 | **Strategy:** Git Flow |
...
| :--- | :--- | :--- |
| **Repo Structure & Naming** | [02-naming-convention-and-structure.md](processing-guide/02-naming-convention-and-structure.md) | Git folder structure roles and file naming rules. |
