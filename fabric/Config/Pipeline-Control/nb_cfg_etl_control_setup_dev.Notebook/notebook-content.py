...
def insert_dim_fact_table_data() -> None:
    data = [
        ...
        (2, "dim_customer", "DIM", "nb_gold_dim_scd2_load_dev.py", 2, "customer_id", True),
        (3, "dim_agent", "DIM", "nb_gold_dim_scd2_load_dev.py", 3, "agent_id", True),
        (4, "dim_provider", "DIM", "nb_gold_dim_scd2_load_dev.py", 4, "provider_code", True),
        (5, "dim_package", "DIM", "nb_gold_dim_scd1_load_dev.py", 5, "package_code", True),
        (6, "dim_coverage", "DIM", "nb_gold_dim_scd1_load_dev.py", 6, "coverage_type", True),
        (7, "dim_quotation", "DIM", "nb_gold_dim_scd1_load_dev.py", 7, "quotation_id", True),
        (8, "dim_policy", "DIM", "nb_gold_dim_scd1_load_dev.py", 8, "policy_id", True),
        (9, "dim_quotation_status", "DIM", "nb_gold_dim_scd1_load_dev.py", 9, "quotation_status_code", True),
        (10, "dim_policy_status", "DIM", "nb_gold_dim_scd1_load_dev.py", 10, "policy_status_code", True),
        (11, "dim_payment_status", "DIM", "nb_gold_dim_scd1_load_dev.py", 11, "payment_status_code", True),
        (12, "dim_payment_method", "DIM", "nb_gold_dim_scd1_load_dev.py", 12, "payment_method_code", True),
        (13, "dim_cancellation_reason", "DIM", "nb_gold_dim_scd1_load_dev.py", 13, "cancellation_reason", True),
        (14, "dim_vehicle", "DIM", "nb_gold_dim_scd2_load_dev.py", 14, "vehicle_id", True),
        (15, "fact_quotation", "FACT", "nb_gold_driver_flow_dev", 15, "quotation_id", True),
        (16, "fact_quotation_item", "FACT", "nb_gold_driver_flow_dev", 16, "quotation_item_id", True),
        (17, "fact_policy", "FACT", "nb_gold_driver_flow_dev", 17, "policy_id", True),
        (18, "fact_payment", "FACT", "nb_gold_driver_flow_dev", 18, "payment_id", True),
        (19, "fact_cancellation", "FACT", "nb_gold_driver_flow_dev", 19, "cancellation_id", True),
    ]
