...
customer_source_rows = [
    Row(customer_id=6, customer_name="An2", email="an1@test.com"),
    Row(customer_id=7, customer_name="Binh2", email="binh1@test.com"),
    Row(customer_id=8, customer_name="Chi2", email="chi1@test.com"),
    Row(customer_id=9, customer_name="Dung2", email="dung1@test.com"),
    Row(customer_id=10, customer_name=None, email="invalid2@test.com"),
]
